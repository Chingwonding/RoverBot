...
<div style="background-color: #f6f8fa; border-radius: 12px; padding: 30px; border: 1px solid #d0d7de;">
  ...
  <p align="center">
    <video src="https://github.com/user-attachments/assets/4a5e4131-554a-46b4-8b8a-489ea3749149" width="450" controls style="border-radius: 10px; border: 2px solid #24292f;"></video>
  </p>
  
  <p style="text-align: center; color: #57606a; font-size: 0.9em; margin-top: 15px;">
    <em>Early wiring configuration and motor response check.</em>
  </p>
</div>
